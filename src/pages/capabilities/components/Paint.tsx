...
const Paint = () => {
  ...
  const content = [
    ...
    "In addition to color customization, we offer a variety of finishes to match your aesthetic and functional requirements. Choose from flat, satin, gloss, high-gloss, metallic, and hammer tone finishes, all designed to provide the perfect look for your product. Our texture options range from smooth to rough, offering solutions that not only enhance appearance but also conceal surface imperfections for a cleaner finish.",
